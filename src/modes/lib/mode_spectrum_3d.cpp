...
{
  return new mode_spectrum_3d(pWidth, pHeight, "Spectrum 3D", pAudioAvailable);
}
 ...
 *
 */
mode_spectrum_3d::mode_spectrum_3d(size_t pWidth, size_t pHeight, string pName, bool pAudioAvailable)
