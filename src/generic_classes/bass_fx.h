...
enum
{
	BASS_BFX_BQF_LOWPASS, BASS_BFX_BQF_HIGHPASS, BASS_BFX_BQF_BANDPASS,					// constant 0 dB peak gain
...
enum
{
	BASS_ATTRIB_TEMPO = 0x10000, BASS_ATTRIB_TEMPO_PITCH, BASS_ATTRIB_TEMPO_FREQ
};
