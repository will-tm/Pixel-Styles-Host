...
rgb_color hsv_to_rgb(hsv_color hsvColor)
{
    ...
    else
    {
        ...
        switch (hh)
        {
            case 0: rgbColor.R = hsvColor.V; rgbColor.G = t; rgbColor.B = p;  break;
            case 1: rgbColor.R = q; rgbColor.G = hsvColor.V; rgbColor.B = p;  break;
            case 2: rgbColor.R = p; rgbColor.G = hsvColor.V; rgbColor.B = t;  break;
            case 3: rgbColor.R = p; rgbColor.G = q; rgbColor.B = hsvColor.V;  break;
            case 4: rgbColor.R = t; rgbColor.G = p; rgbColor.B = hsvColor.V;  break;
            case 5: rgbColor.R = hsvColor.V; rgbColor.G = p; rgbColor.B = q;  break;
            default:rgbColor.R = 0; rgbColor.G = 0; rgbColor.B = 0;  break;
        }
    }
...
hsv_color rgb_to_hsv(rgb_color rgbColor)
{
    ...
    if(hsvColor.V == 0)
        ...
        hsvColor.S = (delta*255) / hsvColor.V;
